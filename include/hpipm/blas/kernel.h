#ifndef TINYHPIPM_BLAS_KERNEL_H
#define TINYHPIPM_BLAS_KERNEL_H
...
// utils
void align_2MB(void* ptr, void** ptr_align);
...
//
void hp_dgemm_nt_m2(int m, int n, int k, double alpha, double* pA, int sda, double* pB, int sdb, double beta, double* C, int ldc, double* D, int ldd);
void hp_dgemm_nt_n2(int m, int n, int k, double alpha, double* pA, int sda, double* pB, int sdb, double beta, double* C, int ldc, double* D, int ldd);
//
