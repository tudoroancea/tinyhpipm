...
class hpipm_dense_qcqp_solver:
    ...
    def solve(self, qcqp, qcqp_sol):
        self.__hpipm.d_dense_qcqp_ipm_solve(
            qcqp.qcqp_struct,
    ...
    def get(self, field):
        ...
        field_name_b = field.encode("utf-8")
        self.__hpipm.d_dense_qcqp_ipm_get(
...
class hpipm_dense_qcqp_solver_arg:
    ...
    def set(self, field, value):
        ...
        field_name_b = field.encode("utf-8")
        self.__hpipm.d_dense_qcqp_ipm_arg_set(
    ...
    def codegen(self, file_name, mode):
        file_name_b = file_name.encode("utf-8")
        mode_b = mode.encode("utf-8")
        self.__hpipm.d_dense_qcqp_ipm_arg_codegen(
            c_char_p(file_name_b),
            c_char_p(mode_b),
            self.dim.dim_struct,
            self.arg_struct,
