...
int main() {
    ...
    int iter;
    d_dense_qp_ipm_get_iter(&dense_workspace, &iter);
    double max_res_stat;
    d_dense_qp_ipm_get_max_res_stat(&dense_workspace, &max_res_stat);
    double max_res_eq;
    d_dense_qp_ipm_get_max_res_eq(&dense_workspace, &max_res_eq);
    double max_res_ineq;
    d_dense_qp_ipm_get_max_res_ineq(&dense_workspace, &max_res_ineq);
    double max_res_comp;
    d_dense_qp_ipm_get_max_res_comp(&dense_workspace, &max_res_comp);
    double* stat;
    d_dense_qp_ipm_get_stat(&dense_workspace, &stat);
    int stat_m;
    d_dense_qp_ipm_get_stat_m(&dense_workspace, &stat_m);
#if PRINT
    printf("\nipm return = %d\n", hpipm_return);
    printf("\nipm iter = %d\n", iter);
