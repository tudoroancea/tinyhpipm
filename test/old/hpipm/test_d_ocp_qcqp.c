...
//	d_print_mat(1, nx_, qN, 1);
    ...
    int iter;
    d_ocp_qcqp_ipm_get_iter(&ipm_work, &iter);
    double res_stat;
    d_ocp_qcqp_ipm_get_max_res_stat(&ipm_work, &res_stat);
    double res_eq;
    d_ocp_qcqp_ipm_get_max_res_eq(&ipm_work, &res_eq);
    double res_ineq;
    d_ocp_qcqp_ipm_get_max_res_ineq(&ipm_work, &res_ineq);
    double res_comp;
    d_ocp_qcqp_ipm_get_max_res_comp(&ipm_work, &res_comp);
    double* stat;
    d_ocp_qcqp_ipm_get_stat(&ipm_work, &stat);
    int stat_m;
    d_ocp_qcqp_ipm_get_stat_m(&ipm_work, &stat_m);
