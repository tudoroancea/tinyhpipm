...
int main() {
    ...
    int_zeros(&ipiv, n, 1);
    int* ipiv_tmp;
    int_zeros(&ipiv_tmp, n, 1);
    int* ipiv_inv;
    int_zeros(&ipiv_inv, n, 1);
    ...
    blasfeo_create_dvec(n, &sx0, x0);
    struct blasfeo_dvec sx1;
    blasfeo_create_dvec(n, &sx1, x1);
    struct blasfeo_dvec sx2;
    blasfeo_create_dvec(n, &sx2, x2);
    struct blasfeo_dvec sx3;
    blasfeo_create_dvec(n, &sx3, x3);
    struct blasfeo_dvec sx4;
    blasfeo_create_dvec(n, &sx4, x4);
    struct blasfeo_dvec sx5;
    blasfeo_create_dvec(n, &sx5, x5);
    struct blasfeo_dvec sx6;
    blasfeo_create_dvec(n, &sx6, x6);
    struct blasfeo_dvec sx7;
    blasfeo_create_dvec(n, &sx7, x7);
    //	struct blasfeo_dvec sx8; blasfeo_create_dvec(n, &sx8, x8);
    //	struct blasfeo_dvec sx9; blasfeo_create_dvec(n, &sx9, x9);

    struct blasfeo_dvec sz0;
    blasfeo_allocate_dvec(n, &sz0);
    struct blasfeo_dvec sz1;
    blasfeo_allocate_dvec(n, &sz1);
    struct blasfeo_dvec sz2;
    blasfeo_allocate_dvec(n, &sz2);
    struct blasfeo_dvec sz3;
    blasfeo_allocate_dvec(n, &sz3);
    struct blasfeo_dvec sz4;
    blasfeo_allocate_dvec(n, &sz4);
    struct blasfeo_dvec sz5;
    blasfeo_allocate_dvec(n, &sz5);
    struct blasfeo_dvec sz6;
    blasfeo_allocate_dvec(n, &sz6);
    struct blasfeo_dvec sz7;
    blasfeo_allocate_dvec(n, &sz7);
    ...
    struct blasfeo_dvec sv;
    blasfeo_create_dvec(n, &sv, v);
    struct blasfeo_dvec svp;
    blasfeo_create_dvec(n, &svp, vp);
    struct blasfeo_dvec svm;
    blasfeo_create_dvec(n, &svm, vm);
    struct blasfeo_dvec sm;
    blasfeo_create_dvec(n, &sm, m);
    struct blasfeo_dvec sr;
    blasfeo_create_dvec(n, &sr, r);
